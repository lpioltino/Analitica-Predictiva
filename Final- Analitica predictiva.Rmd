...
pie(genero$frequencia,labels=etiqueta,clockwise=TRUE,col=colores,main="HYPERTENSION")
...
heart$frequencia<-round((hyper$Freq/5110)*100,2)
etiqueta<-paste(hyper$frequencia,"%",sep = " ")
colores<-c("#00CD00" ,"#FF4500")
pie(genero$frequencia,labels=etiqueta,clockwise=TRUE,col=colores,main="HEART DISEASE")
legend("topright",c("No Tiene","Tiene"),cex=0.9,fill=colores)
```
...
pie(genero$frequencia,labels=etiqueta,clockwise=TRUE,col=colores,main="CASADO")
...
pie(genero$frequencia,labels=etiqueta,clockwise=TRUE,col=colores,main="RESIDENCIA")
